...
|---------------------------------|----------|-------------------------------------|-----------------------------------------------------------------------------------------------------------------|
| ![Grass](https://raw.githubusercontent.com/bananazon/xbolo/refs/heads/main/docs/images/grass.png?raw=true) | Grass | Medium | Most of the island is covered with grass. |
...
| ![Swamp](docs/images/swamp.png) | Swamp | Very Slow | Swamp is usually found in areas near to water. It looks quite similar to normal grass, but will bog your tank down, so watch carefully where you go. |
| ![Mine](docs/images/mine.png) | Mine | | You can lay mines on any terrain (except buildings, boats or water) and they will explode and damage any tank which goes over them. |
| ![Crater](docs/images/crater.png) | Crater | Very Slow | Exploding mines leave craters in the ground. Craters adjacent to water will flood. You can make use of this to build artificial waterways, both for transport by boat and for defensive purposes. |
| ![Road](docs/images/road.png) | Road | Fast | Build roads where you expect to travel frequently. |
| ![Bridge](docs/images/bridge.png) | Bridge | Fast | Build bridges over rivers you expect to have to cross frequently so that you won't lose shells and mines by driving through the water every time. |
| ![Forest](docs/images/forest.png) | Forest | Slow | If your tank is completely enclosed in forest, surrounded on all sides, then other players and pillboxes will not be able to see you. Forest also provides the source of building materials. |
| ![Buildings](docs/images/buildings.png) | Buildings | None (barrier) | 	You can build buildings to make a barrier and provide cover from enemy fire. |
| ![Damaged Building](docs/images/damaged-building.png) | Damaged Building | None (barrier) | If you shoot a building then it becomes damaged. |
| ![Rubble](docs/images/rubble.png) | Damaged Building | Very Slow | If you shoot a building repeatedly then you can reduce it to rubble which you can drive over, but only very slowly. |
| ![Pillbox](docs/images/pillbox.png) | Pillbox | None (barrier) | Pillboxes shoot at any enemy tanks which come into range. You can capture them to make them loyal to yourself, so that they will shoot your enemies for you. |
| ![Damaged Pillbox](docs/images/damaged-pillbox.png) | Damaged Pillbox | None (barrier) | When you shoot a pillbox, it becomes damaged. You can estimate how damaged it is from its appearance on the screen. |
| ![Dead Pillbox](docs/images/dead-pillbox.png) | Dead Pillbox | Medium | If you completely destroy a pillbox, then it becomes inactive and you can drive over it to pick it up. |
| ![Refuleing Base](docs/images/refueling-base.png) | Refueling Base | Medium | Refueling bases provide your tank with more shells, mines and armour. |
